...
export const NEWS: NewsItem[] = [
  { id:1, player:'Kylian Mbappé',        playerId:1, fromClubId:9,  toClubId:3,  from:'PSG',          to:'Real Madrid',  fee:'€180M',  status:'confirmed', journalist:'Fabrizio Romano',    journalistId:1, handle:'@FabrizioRomano', credibility:98.5, time:'2h ago',  publishedAt: '2026-04-29T10:00:00Z' },
  { id:2, player:'Jamal Musiala',         playerId:2, fromClubId:5,  toClubId:2,  from:'Bayern Munich', to:'Man City',     fee:'€120M',  status:'rumour',    journalist:'David Ornstein',     journalistId:2, handle:'@David_Ornstein', credibility:94.1, time:'4h ago',  publishedAt: '2026-04-29T08:00:00Z' },
  { id:3, player:'Pedri',                 playerId:3, fromClubId:4,  toClubId:1,  from:'Barcelona',    to:'Arsenal',      fee:'€90M',   status:'rumour',    journalist:'Fabrizio Romano',    journalistId:1, handle:'@FabrizioRomano', credibility:98.5, time:'6h ago',  publishedAt: '2026-04-29T06:00:00Z' },
  { id:4, player:'Gianluigi Donnarumma',  playerId:5, fromClubId:9,  toClubId:7,  from:'PSG',          to:'Juventus',     fee:'Free',   status:'confirmed', journalist:'Gianluca Di Marzio', journalistId:3, handle:'@DiMarzio',       credibility:91.0, time:'8h ago',  publishedAt: '2026-04-29T04:00:00Z' },
  { id:5, player:'Erling Haaland',        playerId:4, fromClubId:2,  toClubId:3,  from:'Man City',     to:'Real Madrid',  fee:'€200M',  status:'denied',    journalist:'Fabrizio Romano',    journalistId:1, handle:'@FabrizioRomano', credibility:98.5, time:'12h ago', publishedAt: '2026-04-29T00:00:00Z' },
  { id:6, player:'Florian Wirtz',                     fromClubId:6,  toClubId:11, from:'Dortmund',     to:'Liverpool',    fee:'€110M',  status:'rumour',    journalist:'David Ornstein',     journalistId:2, handle:'@David_Ornstein', credibility:94.1, time:'1d ago',  publishedAt: '2026-04-28T12:00:00Z' },
  { id:7, player:'Lamine Yamal',                      fromClubId:4,  toClubId:3,  from:'Barcelona',    to:'Real Madrid',  fee:'€150M',  status:'rumour',    journalist:'Fabrizio Romano',    journalistId:1, handle:'@FabrizioRomano', credibility:98.5, time:'5h ago',  publishedAt: '2026-04-29T07:00:00Z' },
  { id:8, player:'Jonathan Clauss',                   fromClubId:10, toClubId:9,  from:'Marseille',    to:'PSG',          fee:'€12M',   status:'confirmed', journalist:'Gianluca Di Marzio', journalistId:3, handle:'@DiMarzio',       credibility:91.0, time:'3h ago',  publishedAt: '2026-04-29T09:00:00Z' },
];
