"""
La Liga 25/26 이적 데이터 수집 — worldfootball.net 기반
...
출력:
    transfer_news_laliga_ll_2526.sql
"""
...
DB_SEASON   = 51
LEAGUE_NAME = "La Liga"
BOT_HANDLE  = "ll_import_bot"
BOT_NAME    = "La Liga Import Bot"
POST_PREFIX = "WF_LL"
OUT_SQL     = os.path.join(os.path.dirname(__file__), "transfer_news_laliga_ll_2526.sql")
